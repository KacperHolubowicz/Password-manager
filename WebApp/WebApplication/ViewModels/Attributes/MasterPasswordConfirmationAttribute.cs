...
{
    public class MasterPasswordConfirmationAttribute : ValidationAttribute
    {
        public string GetErrorMessage()
        {
            return "Master password confirmation does not match provided password";
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var validation = passwordConfirmation == userVM.MasterPassword
